...
//導入頁面資訊
import {cafeBooking} from '../constants.js'
const tableDataTitle = cafeBooking.tableDataTitle
const dataList = cafeBooking.dataList
const removeUIText = cafeBooking.removeUIText
const onUIText = cafeBooking.onUIText
