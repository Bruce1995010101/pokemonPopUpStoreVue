...
//導入頁面資訊
import {storeBooking} from '../constants.js'
const tableDataTitle = storeBooking.tableDataTitle
const dataList = storeBooking.dataList
const removeUIText = storeBooking.removeUIText
const onUIText = storeBooking.onUIText
